            ...
            steps {
                script{
                  sh """
                     ...
                     sed -i "s/server1/\$PUBLIC_IP1/g" /var/lib/jenkins/workspace/Geocit/ansible/host.txt; \
                     sed -i "s/server2/\$PUBLIC_IP2/g" /var/lib/jenkins/workspace/Geocit/ansible/host.txt; \
                     cat /var/lib/jenkins/workspace/Geocit/ansible/host.txt;
                     """
                }
            }
        }
